...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERPERMISSION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_USERPERMISSION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_USERPERMISSION actions', async () => {
      const arg = { id: 24897 };
    ...
    it('dispatches UPDATE_USERPERMISSION actions', async () => {
      const arg = { id: 24897 };
    ...
    it('dispatches PARTIAL_UPDATE_USERPERMISSION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_USERPERMISSION actions', async () => {
      const arg = 42666;

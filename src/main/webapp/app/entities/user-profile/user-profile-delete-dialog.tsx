...
export const UserProfileDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="morocco2030App.userProfile.delete.question">
        <Translate contentKey="morocco2030App.userProfile.delete.question" interpolate={{ id: userProfileEntity.id }}>

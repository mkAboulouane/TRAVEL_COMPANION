  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="morocco2030App.userProfile.home.createOrEditLabel" data-cy="UserProfileCreateUpdateHeading">
            <Translate contentKey="morocco2030App.userProfile.home.createOrEditLabel">Create or edit a UserProfile</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('morocco2030App.userProfile.phoneNumber')}
              ...
              />
              <ValidatedField
                label={translate('morocco2030App.userProfile.birthDate')}
              ...
              />
              <ValidatedField
                label={translate('morocco2030App.userProfile.nationality')}
                id="user-profile-nationality"
                name="nationality"
                data-cy="nationality"
                type="text"
              />
              <ValidatedField
                label={translate('morocco2030App.userProfile.preferredLanguage')}
                id="user-profile-preferredLanguage"
              ...
              <ValidatedField
                ...
                name="user"
                data-cy="user"
                label={translate('morocco2030App.userProfile.user')}
                type="select"
                required
              >
                <option value="" key="0" />

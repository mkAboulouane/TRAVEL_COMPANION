  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="morocco2030App.permission.home.createOrEditLabel" data-cy="PermissionCreateUpdateHeading">
            <Translate contentKey="morocco2030App.permission.home.createOrEditLabel">Create or edit a Permission</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('morocco2030App.permission.name')}
                id="permission-name"
                name="name"
                data-cy="name"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('morocco2030App.permission.description')}
              ...
              />
              <ValidatedField
                label={translate('morocco2030App.permission.code')}
                id="permission-code"
                name="code"
                data-cy="code"
                type="text"
